...
```javascript
NODE_VERSION = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/process-node-version@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/process-node-version@umd/bundle.js"></script>
```
